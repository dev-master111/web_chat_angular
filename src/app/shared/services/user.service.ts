...
export class UserService {
  ...
  constructor() {
    this._socket = io.connect('https://webchat18api.herokuapp.com:8080', { secure: true, reconnect: true, rejectUnauthorized : false });
    // this._socket = io.connect('http://localhost:8080', { secure: true, reconnect: true, rejectUnauthorized : false });
    this.waitMessages();
